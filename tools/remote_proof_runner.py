  ...
  native-intel:
    ...
    steps:
      ...
      - name: Run offline tuple-bound observation
        ...
        run: |
          set -euo pipefail
          python3 "$RUNNER_TEMP/export/sources/fusion/repo/tools/clean_reproduce.py" --source-root "$RUNNER_TEMP/export/sources/fusion/repo" --tuple "${{ inputs.tuple }}" --platform darwin-x86_64 --runtime-closure-root "$RUNNER_TEMP/export/runtime-closures" --output "$RUNNER_TEMP/observation"
